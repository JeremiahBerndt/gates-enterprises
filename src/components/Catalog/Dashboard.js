...
//           link.innerHTML = '<iframe id="my' + id + '" src="' + src + '" frameBorder="0" height="100%" width="100%"></iframe>';
//           // iFrameResize({
//           //   log: true,
//           //   minHeight: 400,
//           // }, '#my' + id);
            ...
            <Grid item xs={12} lg={9} sx={{ height: '100%' }}>
              ...
              >
                <div style={{ maxWidth: '60em', width: 'inherit', overflow: 'hidden', padding: '1rem' }}>
                  <img src={selectedHouse.image} style={{ width: '120em', height: '100%', objectPosition: '-30em 0' }}></img>
